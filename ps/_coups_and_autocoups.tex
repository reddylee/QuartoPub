...
(\citeproc{ref-thyne2019}{Thyne and Powell 2019}). The well-established
...
\toprule\noalign{}
Regime Type & Country Year & Share & Coups & Coups Percent & Success
Rate & Likelihood \\
\midrule\noalign{}
\endhead
\midrule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
Democracy & 5312 & 46.7\% & 124 & 25.2\% & 51.6\% & 2.3\% \\
Dominant-Party & 2569 & 22.6\% & 82 & 16.6\% & 53.7\% & 3.2\% \\
Personal & 1476 & 13.0\% & 113 & 22.9\% & 44.2\% & 7.7\% \\
Monarchy & 1056 & 9.3\% & 25 & 5.1\% & 56.0\% & 2.4\% \\
Military & 638 & 5.6\% & 110 & 22.3\% & 48.2\% & 17.2\% \\
Other & 322 & 2.8\% & 39 & 7.9\% & 53.8\% & 12.1\% \\
Total & 11373 & 100.0\% & 493 & 100.0\% & 49.9\% & 4.3\% \\
...
\item
  ...
  Political Violence dataset (\citeproc{ref-marshall2005current}{Monty
  G. Marshall 2005}), with 0 representing the most stable conditions (no
...
\\[-1.8ex] & (1) & (2)\\ 
\hline \\[-1.8ex] 
 Constant & $-$1.868$^{***}$ & $-$1.014$^{*}$ \\ 
  & (0.062) & (0.526) \\ 
  & & \\ 
 Regime: Democracy & $-$0.046 & 0.014 \\ 
  & (0.073) & (0.174) \\ 
  & & \\ 
 \hspace{1.6cm}Military & 0.561$^{***}$ & 0.363 \\ 
  & (0.086) & (0.228) \\ 
  & & \\ 
 \hspace{1.6cm}Monarchy & 0.299$^{**}$ & 0.087 \\ 
  & (0.119) & (0.282) \\ 
  & & \\ 
 \hspace{1.6cm}Personalist & 0.241$^{***}$ & $-$0.089 \\ 
  & (0.076) & (0.199) \\ 
  & & \\ 
 Economic trend & $-$0.020$^{***}$ & 0.006 \\ 
  & (0.003) & (0.011) \\ 
  & & \\ 
 GDP per capita & $-$0.026$^{***}$ & $-$0.021$^{**}$ \\ 
  & (0.003) & (0.010) \\ 
  & & \\ 
 Political violence & 0.027$^{**}$ & 0.024 \\ 
  & (0.013) & (0.028) \\ 
  & & \\ 
 No. of Previous coups & 0.079$^{***}$ &  \\ 
  & (0.010) &  \\ 
  & & \\ 
\hline \\[-1.8ex] 
Observations & 9,641 & 9,641 \\ 
Log Likelihood & $-$1,631.677 & $-$1,631.677 \\ 
$\rho$ & 0.564$^{**}$  (0.235) & 0.564$^{**}$  (0.235) \\ 
\hline 
\hline \\[-1.8ex] 
...
\\[-1.8ex] & (1) & (2)\\ 
\hline \\[-1.8ex] 
 Constant & $-$2.418$^{***}$ & $-$1.857 \\ 
  & (0.871) & (2.834) \\ 
  & & \\ 
 Regime: Dominant-party & 0.088 & 0.707$^{*}$ \\ 
  & (0.146) & (0.404) \\ 
  & & \\ 
 \hspace{1.6cm}Military & $-$0.237 & 0.638 \\ 
  & (0.190) & (0.543) \\ 
  & & \\ 
 \hspace{1.6cm}Personalist & 0.794$^{***}$ & 1.652$^{***}$ \\ 
  & (0.157) & (0.449) \\ 
  & & \\ 
 GDP per capita & $-$0.009 & 0.062 \\ 
  & (0.011) & (0.045) \\ 
  & & \\ 
 Economic trend & 1.346$^{*}$ & 1.182 \\ 
  & (0.804) & (2.796) \\ 
  & & \\ 
 Political stability & $-$0.037 & 0.115 \\ 
  & (0.035) & (0.125) \\ 
  & & \\ 
 Age & $-$0.001 & 0.004 \\ 
  & (0.001) & (0.017) \\ 
  & & \\ 
 Population(log) & $-$0.046 & 0.021 \\ 
  & (0.042) & (0.144) \\ 
  & & \\ 
\hline \\[-1.8ex] 
Observations & 1,031 & 103 \\ 
Log Likelihood & $-$308.469 & $-$43.164 \\ 
Akaike Inf. Crit. & 634.938 & 104.328 \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{2}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular}
...
\pandocbounded{\includegraphics[keepaspectratio]{_coups_and_autocoups_files/figure-pdf/fig-logrank-1.pdf}}
...
    Coup-installed leaders & 163 & 163 & 8.38*** & 0.240 & 167 & 167 & 1.87*** & 0.269 \\ 
...
\pandocbounded{\includegraphics[keepaspectratio]{_coups_and_autocoups_files/figure-pdf/fig-coxSurv-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_coups_and_autocoups_files/figure-pdf/fig-coxSurv-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_coups_and_autocoups_files/figure-pdf/fig-coxHR-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_coups_and_autocoups_files/figure-pdf/fig-coxHR-2.pdf}}
...
Democratization(1950--2020): OLS with country-fixed effects}
...
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
 Autocoup & $-$0.119 & $-$0.175 & $-$0.330$^{**}$ & $-$0.296 & $-$0.325 \\ 
  & (0.100) & (0.139) & (0.166) & (0.189) & (0.205) \\ 
  & & & & & \\ 
 Coup & 0.192$^{***}$ & 0.436$^{***}$ & 0.715$^{***}$ & 0.778$^{***}$ & 0.860$^{***}$ \\ 
  & (0.064) & (0.088) & (0.105) & (0.117) & (0.128) \\ 
  & & & & & \\ 
 GDP per Capita & $-$0.004 & $-$0.008$^{**}$ & $-$0.010$^{**}$ & $-$0.011$^{*}$ & $-$0.011$^{*}$ \\ 
  & (0.003) & (0.004) & (0.005) & (0.006) & (0.006) \\ 
  & & & & & \\ 
 Economic Trend & $-$0.107 & $-$0.318 & $-$0.619 & $-$0.795 & $-$0.738 \\ 
  & (0.262) & (0.366) & (0.438) & (0.493) & (0.540) \\ 
  & & & & & \\ 
 Log Population & 0.333$^{***}$ & 0.711$^{***}$ & 1.147$^{***}$ & 1.599$^{***}$ & 2.051$^{***}$ \\ 
  & (0.072) & (0.101) & (0.121) & (0.138) & (0.153) \\ 
  & & & & & \\ 
 Political Violence & 0.007 & 0.017 & 0.027 & 0.038 & 0.056$^{*}$ \\ 
...
Second, I modify the treatment of autocoups by replacing the decay
effects with a dummy variable that differentiates between attempted and
successful autocoups. As expected, this adjustment does not alter the
core results, though it leads to differences in regression coefficients.
...
\\[-1.8ex] & (1) & (2) & (3) & (4)\\ 
\hline \\[-1.8ex] 
 Autocoup & $-$0.142 & $-$0.400 & $-$0.338 & $-$0.640$^{**}$ \\ 
  & (0.244) & (0.291) & (0.269) & (0.321) \\ 
  & & & & \\ 
 Coup & 0.672$^{***}$ & 0.937$^{***}$ & 0.845$^{***}$ & 1.384$^{***}$ \\ 
  & (0.126) & (0.150) & (0.171) & (0.203) \\ 
  & & & & \\ 
 GDP per Capita & $-$0.008$^{*}$ & $-$0.010$^{**}$ & $-$0.008$^{**}$ & $-$0.010$^{**}$ \\ 
  & (0.004) & (0.005) & (0.004) & (0.005) \\ 
  & & & & \\ 
 Economic Trend & $-$0.254 & $-$0.537 & $-$0.318 & $-$0.619 \\ 
  & (0.366) & (0.439) & (0.366) & (0.438) \\ 
  & & & & \\ 
 Log Population & 0.725$^{***}$ & 1.157$^{***}$ & 0.711$^{***}$ & 1.147$^{***}$ \\ 
  & (0.101) & (0.122) & (0.101) & (0.121) \\ 
  & & & & \\ 
 Political Violence & 0.015 & 0.026 & 0.017 & 0.027 \\ 
  & (0.020) & (0.023) & (0.020) & (0.023) \\ 
  & & & & \\ 
 Non-Democracy & 1.672$^{***}$ & 2.412$^{***}$ & 1.685$^{***}$ & 2.431$^{***}$ \\ 
  & (0.087) & (0.105) & (0.087) & (0.105) \\ 
  & & & & \\ 
 Cold War & $-$0.230$^{***}$ & $-$0.228$^{**}$ & $-$0.237$^{***}$ & $-$0.239$^{**}$ \\ 
  & (0.088) & (0.105) & (0.088) & (0.105) \\ 
  & & & & \\ 
\hline \\[-1.8ex] 
Observations & 8,863 & 8,695 & 8,863 & 8,695 \\ 
R$^{2}$ & 0.051 & 0.075 & 0.051 & 0.076 \\ 
Adjusted R$^{2}$ & 0.032 & 0.056 & 0.032 & 0.057 \\ 
F Statistic & 58.555$^{***}$ & 86.739$^{***}$ & 58.212$^{***}$ & 88.093$^{***}$ \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{4}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular}
...
Upon comparing Columns 3 and 4 in Table~\ref{tbl-demomodel2} and
Table~\ref{tbl-demomodel}, it is evident that substituting the decay
factor for autocoups and coups with a dummy variable significantly
doubles the estimated effects. This finding is consistent with
expectations, as the decay factor distributes the influence of events
over the subsequent four years, whereas the event dummy captures their
impact solely in the year of occurrence.

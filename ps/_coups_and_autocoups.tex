...
Finally, employing survival analysis, the study examines the
relationship between power acquisition methods and leadership tenure.
The findings reveal that, at any given point during their tenure,
coup-installed leaders are 2.23 times more likely to be ousted from
power than autocoup leaders, all else being equal. This disparity
suggests that autocoups may serve as a catalyst for both the
personalization of power and the erosion of democratic norms and
institutions.
...
This research originates from a crucial question: \textbf{What factors
determine whether political leaders are prematurely ousted from power or
manage to extend their tenure beyond constitutionally prescribed
limits?} This inquiry is particularly relevant in the current global
landscape, characterized by widespread democratic erosion and a
resurgence of authoritarianism. Notably, Freedom House's \emph{Freedom
in the World 2024} report reveals a concerning trend: global freedom
declined for the 18th consecutive year in 2023, with political rights
and civil liberties diminishing in 52 countries and improvements
observed in only 21 (\citeproc{ref-freedomhouse2024freedom}{Freedom
House 2024}). This global decline in freedom underscores the pressing
need to understand the factors influencing leadership transitions and
the stability of political systems.

This study addresses three primary research questions, which form the
core of the subsequent chapters:
...
\item
  ...
  coups, and what insights can be gained from this approach?
\item
  ...
  autocoup, have a significant impact on leadership longevity?
\end{itemize}
...
personalist regimes are 94\% more likely to experience coups, all else
being equal. This heightened vulnerability can be attributed to the
weaker institutional frameworks and internal power struggles
characteristic of these regimes.

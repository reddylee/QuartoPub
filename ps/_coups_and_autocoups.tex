...
since the early 2000s (\citeproc{ref-thyne2019}{C. L. Thyne and Powell
2019}), a consensus on the key factors driving coup attempts and their
...
This chapter contributes to the existing literature by introducing a
novel approach that prioritizes determinants based on their impact on
coup success, emphasizing the expected probability of success as a
critical factor in the decision-making calculus of potential coup
plotters. Employing a double probit model with sample selection, this
chapter investigates the relationship between regime types and coup
attempts, with a particular focus on the balance of power between coup
plotters and incumbent leaders. The findings confirm that regime type is
a significant determinant of coup likelihood. Notably, compared to
dominant-party regimes, military regimes are 277.7\% more likely and
personalist regimes 94\% more likely to experience coups.
...
and why some coups succeed while others fail}. This chapter aims to
contribute to scholarly discourse by emphasizing the expected chances of
success as a driver of coup attempts and highlighting the significance
of regime type in shaping coup susceptibility.

According to the Global Instances of Coups dataset (GIC)
...
The decision to undertake a coup is driven by a complex interplay of
motivations and capabilities. Three primary categories of motivations
emerge: personal ambition, purported national interest, and
self-preservation.
...
\item
  ...
  coup in Niger, which ousted President Tandja after he sought an
  unconstitutional third term by dissolving the opposing court and
  orchestrating a favourable referendum
...
capabilities of potential perpetrators. However, this approach overlooks
a crucial factor: the dynamic balance of power between those initiating
a coup and the incumbent regime. Even when dispositions and capabilities
are similar, coup outcomes can vary drastically depending on this
balance. This variation underscores that the balance of power acts as a
mediating factor, influencing the strategic calculus of potential coup
plotters.

For example, viewing military strength as the sole determinant of coup
attempts oversimplifies the complex reality of these events
(\citeproc{ref-singh2016}{Singh 2016}). In a highly centralized
personalist regime, control over the military might be concentrated in
the hands of a small, loyalist faction, making it difficult for
potential rivals to garner the support necessary for a successful coup.
Conversely, in a more fragmented military regime, internal divisions and
competing power centres could create opportunities for ambitious
officers to mobilize support and challenge the ruling junta. As Geddes
...
significant challenges for outside observers, including policy-makers,
international organizations, and even potential coup plotters
themselves. An alternative approach, and the one adopted in this study,
is to analyze factors that are decisive in shaping power dynamics. This
...
\item
  \textbf{Dominant-rarty regimes:} Power resides within a well-organized
...
for only 16.7\% of coups (Table~\ref{tbl-regimes}). These statistics
...
These results strongly support the theoretical framework outlined in
this chapter, underscoring the crucial role that regime structure and
the expected probability of coup success play in determining a regime's
vulnerability to overthrow. The findings emphasize that coups are
strategic actions undertaken when the odds appear favourable, rather
than random events.

The implications of these findings for real-world politics are
significant. Since the perceived chances of successful coup execution
are so pivotal in coup attempts, incumbent leaders - especially those in
autocratic regimes - will be highly incentivized to focus their efforts
on reducing the capabilities of potential coup plotters, rather than
simply addressing the underlying dispositions toward staging a coup.

In practice, this means autocratic leaders are likely to prioritize
``coup-proofing'' strategies, such as handpicking loyal generals and
officials over competent ones, creating factional divisions within the
elite, and removing capable or popular military officers and government
officials - even if they remain loyal. However, this can lead to a
vicious cycle.

As the old Chinese proverb states, ``A step forward in righteousness is
met with an even greater rise in opposition.'' Just when incumbents
believe they have solved the problem of coup risk, new challenges can
emerge. The suppression of potential rivals inevitably breeds dissent
and grievances, making the disposition toward staging a coup even more
appealing. While capability is more crucial, the disposition for a coup
cannot be completely ignored, as severe crackdowns on the opposition may
ultimately lower the perceived costs of attempting a takeover.
...
undertaking, fueled by discontent and perceptions of vulnerability,
...
Furthermore, if incumbent leaders devote excessive attention to
coup-proofing at the expense of economic growth and social development,
they are likely to resort to increasingly autocratic forms of ruling.
This, in turn, can lead to democratic backsliding or even outright
breakdown, as well as the entrenchment of authoritarian and
personalistic rule.

In summary, the findings of this study offer critical insights into the
complex dynamics underlying coup attempts and the strategic calculus of
incumbent regimes. Navigating these challenges will require a delicate
balance between addressing the capabilities and dispositions of
potential coup plotters, while also maintaining a focus on broader
governance, economic, and social priorities.

\section{Summary}\label{summary}

This chapter delves into the persistent threat of coups that destabilize
political systems and disrupt democratic transitions worldwide. Despite
extensive scholarly attention, understanding why certain regimes are
more vulnerable to coups than others remains a challenging puzzle. This
study introduces a fresh perspective by emphasizing determinants that
impact coup success, moving beyond the mere capability to launch a coup
and focusing on the expected probability of success. This approach
highlights the crucial role played by the perceived balance of power
between coup plotters and the regime in determining outcomes.
...
influences coup vulnerability. Specifically, military and personalist
regimes exhibit higher susceptibility to coups compared to
dominant-party regimes, a finding corroborated by historical examples.
For instance, military regimes in Latin America during the 20th century
and various African personalist regimes have experienced frequent
instability and coup attempts. The study underscores the importance of
building regimes with strong constitutional institutions, as those
reliant on military or personal authority prove to be more prone to
coups.
...
strengthening institutions could promote regime longevity and reduce the
risk of coups, many autocrats resist such reforms due to the potential
limitations they might impose on their power. Institutionalization,
while beneficial for the regime's long-term stability, may not align
with the short-term interests of individual leaders who prioritize their
personal control and authority over broader regime security.

The study also points to policy implications for enhancing political
stability. Promoting economic development, strengthening institutional
frameworks, and encouraging political inclusivity are identified as
strategies that can create more stable and resilient political systems.
This shift towards institutionalization could help reduce the volatility
that often accompanies military and personalist regimes.

Moreover, this research opens several avenues for further inquiry, such
as:
...
\item
  ...
  personalization.
\item
  Examining the role of international factors in influencing regime
...
\begin{itemize}
\item
  \textbf{Coup-installed leaders}: Their illegitimacy is explicit due to
  the open seizure of power.
\item

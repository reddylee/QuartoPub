...
\item
  ...
  odds of a successful coup (\citeproc{ref-powell2018}{J. Powell et al.
...
This chapter seeks to provide a nuanced understanding of autocoups by
clarifying the concept and its distinct characteristics, with a specific
focus on power extensions by incumbent leaders. By delineating autocoups
from the more encompassing and ambiguous concepts of self-coups or
executive takeovers, which conflate executive power aggrandizement and
power extension, this research offers a refined definition of autocoups.
Building on this conceptual framework, a novel dataset of autocoup
events spanning 1945 to 2023 is introduced. The study employs a
mixed-methods approach, combining three types of qualitative case
studies that provide in-depth insights into the dynamics of autocoups
with a quantitative analysis of the determinants of autocoup attempts
and success. This empirical examination demonstrates the utility of the
autocoup dataset for future research. This study contributes to the
existing literature by providing a clearer conceptual framework, a novel
dataset, and a deeper understanding of the mechanisms and motivations
underlying power extensions by incumbent leaders. Furthermore, it
explores the implications of autocoups for democratic resilience,
...
\item
  ...
  overstay, and continuismo are used interchangeably without clear,
  universally accepted definitions. This lack of standardization leads
...
the termination of their tenure. In contrast, autocoups often involve
incumbent leaders consolidating power by seizing control from other
state institutions, rather than solely extending their tenure. As a
result, coups and autocoups are frequently analysed in isolation,
despite their interconnected nature. This separation has led to a dearth
of comparative analyses, hindering a more comprehensive understanding of
the complex dynamics between these two types of power seizures.

Studying autocoups is crucial for several reasons. Firstly, autocoups
...
future irregular power transitions. For instance, since 1945,
...
A significant limitation in the field of coup studies is the lack of
integration between research on autocoups and classic coups. Despite
their interconnected nature, these two phenomena are often analysed in
isolation, hindering a comprehensive understanding of power seizure
dynamics. This separation stems from a conceptual disconnect in how
these events are defined and categorized.

Classic coups are typically characterized by the complete removal of
incumbent leaders, focusing on the abrupt termination of their tenure.
In contrast, autocoups involve a more nuanced power dynamic, where
incumbent leaders consolidate their authority by seizing control from
other state institutions, rather than solely extending their tenure.
This fundamental difference in the mechanism of power alteration has led
to disparate analytical approaches.
...
and Malamud 2019}). While these terms can be helpful in specific
contexts, their proliferation often contributes to overall confusion
rather than providing clarification. Most of these terms focus on the
specific methods employed by coup perpetrators but fail to clearly
identify the perpetrator, necessitating further explanation. Moreover,
many of these methods could be employed either by or against executive
leaders, further muddying the waters.
...
While terminology is crucial, another issue arises with previous
definitions of autocoups: What is the primary emphasis---power
...
types. The findings reveal that coup-installed leaders are significantly
more vulnerable to removal from office compared to their autocoup
counterparts. These results have far-reaching implications for political
stability and democratic processes, suggesting that the perceived low
costs and high rewards associated with autocoups may incentivize
incumbents to prolong their tenure through this means, potentially
contributing to democratic erosion. This research makes a notable
contribution to the academic literature by offering nuanced insights
into the dynamics of irregular leadership transitions and enhances our
...
dataset highlights the prevalence of such irregular transitions: between
1945 and 2015, over half of leaders who assumed power irregularly (158
out of 308) also exited irregularly, a rate significantly surpassing
that of leaders who accessed office through regular channels, of whom
only 14.5\% (213 out of 1,472) experienced irregular departures.
...
\item
  ...
  Notably, military regimes face a higher risk of coups compared to
  dominant-party regimes, despite having more control over their
  military forces.
\item
...
\item
  ...
  autocoup leaders. Coup-installed leaders face a significantly higher
  risk of removal compared to autocoup leaders, who enjoy longer
  extended tenures.
\end{itemize}
...
redefining autocoups, classifying the dataset, analyzing determinants,

...
This dissertation investigates the dynamics of irregular power
transitions, focusing on coups and autocoups, and their impact on leader
survival. Through a comprehensive analysis of historical data, case
studies, and advanced quantitative modelling, this research enhances our
understanding of political power dynamics and the complex factors
influencing leadership longevity following irregular transitions.

The study begins by examining the crucial role of power dynamics, shaped
by regime type, in determining coup success rates and attempt frequency.
Employing a double probit model with sample selection, the research
demonstrates that the anticipated likelihood of coup success
significantly affects coup attempts, with military regimes exhibiting
particular vulnerability due to their inherent power structure.

While often overlooked in existing literature, autocoups are revealed to
have a profound impact on democratic backsliding. This study introduces
a refined definition of autocoups and presents a novel dataset covering
events from 1945 to 2024, facilitating more robust quantitative analysis
of this phenomenon.

Utilizing survival analysis techniques, the research compares the tenure
of leaders who ascend to power through coups versus autocoups. The
findings indicate that coup-installed leaders experience significantly
shorter tenures and face higher risks of removal. In contrast, autocoup
leaders, who manipulate existing systems to extend their rule, tend to
remain in power longer. This disparity suggests that autocoups may
incentivize power grabs and contribute to democratic erosion.
...
\begin{itemize}
\item
  Conceptual clarity: Establishes a precise definition of autocoups,
  addressing a gap in the current understanding of this understudied
  phenomenon.
\item
  Data innovation: Introduces a comprehensive dataset on autocoups,
  enabling more extensive quantitative analyses and fostering future
  research in this area.
\item
  Analytical framework: Develops a unified approach for studying both
  coups and autocoups, allowing for comparative analysis of these
  critical political events and their potential effects on democratic
  backsliding.
\end{itemize}

\emph{\textbf{Keywords:} Coups, Autocoups, Power transitions, Leadership
survival, Democratic backsliding, Regime type, Political instability}
...
(\citeproc{ref-powell2011}{Powell and Thyne 2011}) records an even
...
(\citeproc{ref-thyne2019}{Thyne and Powell 2019}). This scholarly focus
has resulted in a general consensus on the definition of coups, as well
as the development of comprehensive datasets for quantitative analyses.
While debates on the precise definition persist, most scholars,
including this study, adhere to the definition proposed by Powell and
Thyne (\citeproc{ref-powell2011}{2011}). This widely accepted definition
...
Coups d'état, defined by Powell and Thyne
...
\begin{tabular*}{0.9\linewidth}{@{\extracolsep{\fill}}lccr}
\toprule
...
\item
  ...
  successful coup (\citeproc{ref-powell2018}{Powell et al. 2018};
...
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{0.95\linewidth}{@{\extracolsep{\fill}}llrr}
\toprule
...
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{1\linewidth}{@{\extracolsep{\fill}}l>{\raggedright\arraybackslash}p{\dimexpr 150.00pt -2\tabcolsep-1.5\arrayrulewidth}rr}
\toprule
...
leaders (approximately 5.7 years), suggesting a potential tenure gap of
over five years.
...
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{1\linewidth}{@{\extracolsep{\fill}}>{\raggedright\arraybackslash}p{\dimexpr 75.00pt -2\tabcolsep-1.5\arrayrulewidth}>{\raggedright\arraybackslash}p{\dimexpr 187.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\raggedright\arraybackslash}p{\dimexpr 187.50pt -2\tabcolsep-1.5\arrayrulewidth}}
\toprule

...
-   **Declaring permanent leadership**: If a leader, upon assuming power,
    formally declares themselves the permanent leader, this is a clear autocoup
    attempt.

-   **Cancelling or delaying elections**: Cancelling or delaying scheduled
    elections without legitimate justification suggests an attempt to cling to
    power.

-   **Refusing unfavourable election results**: Refusal to accept unfavorable
    election results and attempts to overturn them through illegitimate means
    constitute an autocoup.

-   **Excluding opposition in elections**: Rigging the electoral process by
    excluding opposition parties or candidates from participation, effectively
    creating a one-candidate race, signifies an autocoup.

...
autocoup |> 
  summarise(autocoup_attempted = n(),
            ...
            Success_rate = percent (autocoup_succeeded/autocoup_attempted),
    .by = autocoup_method) |> 
...
Examining the success rates of various autocoup methods, we find that removing
term limits, delaying elections, declaring the leader for life, and canceling
elections are all 100% successful. These four types of autocoups are notably more
blatantly illegitimate compared to other methods, indicating that the leaders who
employ these tactics may hold more substantial power. In contrast, there are only
4 cases of refusing election results, with just one succeeding. Although this
sample is small, it suggests that in regimes where general elections are held and

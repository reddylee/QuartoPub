...
```{r}
#| lable: data_descriptions
#| eval: !expr format == "latex"
#| echo: false
autocoup <- read_excel(here("data/autocoup_Reddy.xlsx"))
country <- autocoup |> 
  distinct(ccode) |> 
  summarise(count = n())
country
...
According to the primary coding, we have 113 autocoup cases from 1945 to 2021.
The 113 autocoups involve `r country$count` countries.

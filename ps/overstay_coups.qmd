...
-   **Enabling Re-election:** In some countries, constitutions initially bar
    re-election or immediate re-election. Incumbents can manipulate these
    restrictions to allow themselves to run again. President Menem of Argentina
    in 1993 exemplifies this tactic.

-   **Constitutional Reset:** This tactic allows incumbents to bypass term limits
    by amending the constitution to reset their previous terms. This effectively
    grants them eligibility for one or two additional terms, potentially
    repeatable, for a near-indefinite hold on power. Russian President Vladimir
    Putin exemplifies this strategy, having extended his rule beyond two decades
...
-   **Cancelling, Delaying, or Removing Elections:** Cancelling, delaying, or
    removing scheduled elections without legitimate justification is a frequent
    method used by incumbents to maintain power. For instance, Chadian President
    François Tombalbaye delayed general elections until 1969 after assuming power
    in 1960. Similarly, Angolan President José Eduardo dos Santos suspended
    elections throughout his rule from 1979 to 2017.
...
observations, with X overlapping with the candidate data from Incumbent Takeover.
The remaining Y events were newly coded by the author through verification with
other sources such as Archigos, REIGN, and news reports.The main deviation from
the Incumbent Takeover dataset arises from excluding power expansions that do not

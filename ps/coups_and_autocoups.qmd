...
Irregular power transitions, characterized by a disregard for constitutional
procedures, represent a critical area of study in political science. These
transitions not only disrupt established rules but often employ unconstitutional
tactics to consolidate power post-transition. Moreover, such events can inspire
emulation among other ambitious leaders, potentially triggering a cascade of
similar actions across different political contexts.

Despite extensive research on irregular power transitions, a fundamental question
continues to challenge political scientists: ***Why do some leaders face
premature ousting while others complete their full terms or even extend their
tenure beyond constitutionally mandated limits?*** This inquiry extends to
understanding the stark disparities in leadership longevity, where some rulers
maintain power for decades while others' tenures are measured in years, months,
or even days.

This dissertation focuses on this central question, aiming to provide a
comprehensive analysis dedicated to understanding how leaders ascend to power
through unconstitutional means, and what factors determine the duration of a
leader's rule following an irregular ascent to power.

### Coups and Autocoups: A Comparative Framework for Irregular Power Transitions
...
research, particularly since 2000 [@thyne2019]. Most scholars, including this
study, adhere to Powell and @powell2011 definition: "illegal and overt attempts
by the military or other elites within the state apparatus to unseat the sitting
executive... \[a coup is successful\] if the perpetrators seize and hold power
for at least seven days" (p. 252). This definition emphasizes two key elements:
the involvement of internal elites and the complete removal of incumbents.
...
their mandated terms. While the concept of "irregular retention of power" has
been discussed in various literatures from different perspectives, it has not
been systematically analysed as a form of irregular power transition. This
oversight may stem from the technicality that no apparent transfer of power
occurs in these situations. Nevertheless, this phenomenon, although distinct from
traditional coups, constitutes an irregular power transition in that it subverts
the expected and legally mandated change in leadership.

Compared to tranditional coups, the study of "irregular retention of power" faces
several challenges:

-   **Terminology**: Unlike the universally accepted term "coup," various terms
...
-   **Definition**: Existing definitions often conflate power expansion and power
    ...
    terms of power expansion, which is not align with the definition of coup.
...
To address this gap in the literature and provide a framework for analysis, I
...
Both phenomena significantly influence democratic backsliding and represent the
most frequent means of irregular power transition. Moreover, their similar
nomenclature reflects a fundamental similarity: while a coup aims to replace the
current leader, an autocoup seeks to prevent the succession of a future leader.
This comparative approach will enable a more nuanced analysis of irregular power
transitions, contributing to our understanding of political stability, democratic
erosion, and leadership longevity in various regime types.
...
-   **Emphasis on Power Dynamics and Regime Types:**
    I highlight the significant role of power dynamics, particularly the
    influence of regime types, in determining the success and frequency of coup
    attempts. The analysis underscores how the expected chances of coup success
    motivate such attempts, with military regimes being notably susceptible. This
    approach provides a more nuanced understanding of the structural factors that
    shape irregular power transitions.

-   **Refined Definition and Novel Dataset for Autocoups:**
    I introduce a refined definition of autocoups and develop a novel dataset
    covering events from 1945 to 2024. This contribution fills a significant gap
    in the existing literature and enables a comparative analysis with classic
    coups. By providing clearer insights into the nature and impact of autocoups
    on political systems, I enhance the scholarly understanding of this
    understudied phenomenon. The autocoup dataset offers a valuable resource for
    future research in this area.

-   **Survival Analysis of Leaders from Different Entry Modes:**
    By applying survival analysis to existing coup data and the new autocoup
    dataset, I demonstrate how different modes of entry into power significantly
    affect leader survival. The findings reveal that leaders who come to power
    through coups typically have shorter tenures and face higher removal risks
    compared to those who extend their rule through autocoups. This comparative
    analysis provides a more comprehensive picture of leadership longevity in the
    context of irregular power transitions.
...
intensification. This research underscores the significance of irregular power
transitions as a key factor in democratic erosion within regimes.

Irregular power transitions, predominantly manifesting as coups or auto-coups,
violate democratic or constitutional norms and disrupt the trajectory towards
stable democracies or democratization from autocracies. Leaders who ascend to
power through these irregular means often undermine constitutional norms to seize
or overstay in power. Subsequently they employ illegal methods to suppress
political opponents, which create a vicious cycle of eroding democratic
institutions.

Freedom House reports an 18th consecutive year of global freedom decline in 2023
[@freedomhouse2024freedom]. While complete regression to autocracy remains rare,
the average global democracy level has regressed to pre-2000 levels. Notably,
democratic backsliding often occurs within regimes, democracies are becoming less
liberal, and autocracies are becoming less competitive [@mechkova2017].

The findings of this study provide a logical explanation for these phenomena,
particularly given that autocoups have become more prevalent than traditional
coups since 2000 [@bermeo2016]. Importantly, autocoups typically do not result in
immediate regime change, contributing to the observed pattern of within-regime
democratic erosion.

Moreover, this study offers several explanations for the increasing prevalence of
autocoups over classic coups in the past two decades:

-   **Higher Success Rate**: Autocoups have a significantly higher probability of
    success compared to traditional coups.

-   **Mitigated Consequences**: Even when unsuccessful, the repercussions of
    autocoups are generally less severe than those of failed traditional coups.

-   **Extended Tenure**: Successful autocoup leaders tend to maintain power for
    substantially longer periods than leaders who enter through traditional
    coups.

These factors collectively contribute to the growing preference for autocoups as
a means of irregular power transition, with significant implications for
democratic stability and governance worldwide.

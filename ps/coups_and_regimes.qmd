...
\end{aligned}
$$ Since a given year's situation is primarily determined by the previous year,
the variable is lagged by one year. The GDP per capita (in constant 2017
...
We can see from Table \ref{results} that the regime type has a significant impact
on.

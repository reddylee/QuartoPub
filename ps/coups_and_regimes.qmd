...
Following these purges and any external challenges, a new power dynamic emerges
among the factions. These regimes evolve into one of the three main types
discussed earlier: military regimes, personalist regimes, and dominant-party
regimes.

The differing power dynamics significantly impact the likelihood of coup
attempts. According to @tbl-regimes, military regimes face the highest risk of
coups, representing only 5.6% of country-years yet accounting for over 22% of
coups. Personalist regimes follow, comprising 13% of country-years and
responsible for 23% of coups. Dominant-party regimes, however, have the lowest
incidence among these three types, constituting 22.6% of country-years but
accounting for only 16.7% of coups.

...
@aidt2019 suggests that a coup is likely to be initiated when the anticipated benefits of a successful coup outweigh the potential costs of failure. This implies that the decision to orchestrate a coup is heavily influenced by the perceived probability of success. While the discussion of @eq-eq1 in @leon2013 may appear technical and theoretical, it raises practical challenges in quantifying the values of $V_S$ and $C$, which are not easily measurable in real-world terms and cannot be exchanged in a public market. Coup plotters are motivated by more than just superficial gains or losses, as I will delve into further in the subsequent chapter. Nonetheless, the underlying logic of the equation remains robust and offers a valuable framework for comprehending the decision-making dynamics of coup plotters.

There is a notable disparity between the number of studies focusing on coup attempts and those examining the outcomes of coups.
Among these fewer discussions on coup outcomes, @powell2012 employs a selection model using global data from 1961 to 2000 to investigate the determinants and consequences of coups.
His findings suggest that coup-proofing strategies, such as counterbalancing and providing organizational resources to the military, effectively reduce the likelihood of coups but increase their chances of success.
@böhmelt2014 propose a U-shaped relationship between institutional coup-proofing and coup outcomes, which they test using time-series cross-section data.
While they find strong support for their claims regarding coup attempts, the evidence is less robust for coup outcomes.
Conversely, @bell2016 argues that democracies are less susceptible to coups, yet coups attempted against democracies are more likely to succeed.
However, this assertion lacks support from the data analysed in this study.
Additionally, @bell2015 explore the relationship between ongoing civil wars and coup activity, finding that coup attempts during wartime are significantly less likely to succeed.

However, few of the aforementioned studies have considered the interdependence between coup attempts and coup success.
Although @powell2012 also employs a sample selection model and simultaneously considers both coup attempts and coup success, his primary focus is on military expenditure, personnel, and coup-proofing strategies, such as paramilitary measures, rather than the dynamics of power balance within different types of regimes.

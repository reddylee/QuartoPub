...
abstract: |
  This study examines how the method of attaining power impacts the longevity of coup-entry leaders and autocoups leaders. We hypothesize that the accession method significantly affects leader tenure. Utilizing Cox proportional hazards and time-dependent Cox models, we provide compelling evidence of differing survival times between these leader types. The findings indicate a 2.42 times higher risk of removal for coup-entry leaders compared to autocoup leaders. This study highlights the implications of these findings for political stability and democratic processes, suggesting that the relative ease and high returns of autocoups could incentivize more incumbents to seize power in this manner, potentially leading to democratic backsliding. The research also underscores the importance of understanding the nuances of irregular leadership transitions and contributes to the academic literature by providing a new dataset on autocoups, which has not been widely recognized previously.
